...
The function should recursively loop through the `obj` object and search for a key named like the `key` argument. When found, 
it should replace the value for that key with the `value` parameter given to the function. Then it should return the given `obj`.
*/
