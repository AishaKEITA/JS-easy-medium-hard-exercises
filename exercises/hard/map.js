/* 
Write a function called `map` that takes two arguments. The first argument `f` should be a function, 
the second argument `arr` should be an array containing any values. 
